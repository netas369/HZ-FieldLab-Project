          ...
          <li v-for="tab in tabs" :key="tab.id">
            ...
            >
              ...
              <div :class="[
                ...
                activeTab === tab.id ? '' : 'text-slate-400 dark:text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-400'
              ]">
...
// Quick links
const quickLinks = [
  { id: 'export', label: 'Export Data', icon: 'download', action: 'export' },
  { id: 'documentation', label: 'Documentation', icon: 'book', action: 'docs' },
  { id: 'support', label: 'Support', icon: 'help', action: 'support' }
]
