  ...
  <div class="transition-colors duration-200">
    ...
    >
      ...
      >
        <div class="flex items-center">
          <div
            class="animate-spin rounded-full h-5 w-5 border-b-2 border-blue-600 dark:border-blue-400 mr-3"
          />
    ...
    >
      ...
      >
        <div class="flex items-center">
          <svg
            class="w-5 h-5 text-green-600 dark:text-emerald-400 mr-3"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
          ...
          <div>
            <h4 class="font-semibold text-green-900 dark:text-emerald-200">
      ...
      <div>
        <h3 class="font-semibold text-gray-900 dark:text-white mb-2">
          Detected Columns ({{ parsedData.headers.length }})
        </h3>
        <div class="flex flex-wrap gap-2">
          <span
            v-for="(header, index) in parsedData.headers"
            :key="index"
        ...
        <div class="overflow-x-auto border border-gray-300 dark:border-slate-700 rounded-lg">
          <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
            <thead class="bg-gray-50 dark:bg-slate-800">
              <tr>
                <th
                  class="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-slate-400 uppercase"
                >
                  #
                </th>
                <th
            ...
            >
              ...
              >
                <td class="px-3 py-2 text-sm text-gray-500 dark:text-slate-500">
                  {{ index + 1 }}
                </td>
                <td
                  v-for="header in parsedData.headers"
