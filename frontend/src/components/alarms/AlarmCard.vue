<template>
  ...
  >
    ...
    <div :class="['absolute top-0 left-0 right-0 h-1', gradientClass]" />
    ...
    <div class="relative p-5">
      ...
      <div class="flex items-start justify-between mb-3">
        ...
        <div class="flex items-center gap-2">
          ...
          >
            ...
            <span
              v-if="
                !alarm.acknowledged && (alarm.priority === 'Critical' || alarm.priority === 'Major')
              "
      ...
      >
        ...
        <!-- Right: Priority Icon -->
        <div :class="['p-2 rounded-lg transition-transform group-hover:scale-110', priorityIconBg]">
          <svg
            class="w-4 h-4"
            fill="currentColor"
            viewBox="0 0 20 20"
...
const borderColorClass = computed(() => {
  const colors = {
    ...
    Major:
      'border-orange-200 dark:border-orange-900/50 hover:border-orange-400 dark:hover:border-orange-700',
    Warning:
      'border-amber-200 dark:border-amber-900/50 hover:border-amber-400 dark:hover:border-amber-700',
    Minor:
      'border-blue-200 dark:border-blue-900/50 hover:border-blue-400 dark:hover:border-blue-700',
  }
...
const priorityBadgeClass = computed(() => {
  const classes = {
    Critical:
      'bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300 ring-2 ring-red-200 dark:ring-red-800',
    Major:
      'bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-300 ring-2 ring-orange-200 dark:ring-orange-800',
    Warning:
      'bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-300 ring-2 ring-amber-200 dark:ring-amber-800',
    Minor:
      'bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 ring-2 ring-blue-200 dark:ring-blue-800',
  }
  return (
    classes[props.alarm.priority] ||
