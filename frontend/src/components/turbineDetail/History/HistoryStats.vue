...
defineProps({
  stats: {
    type: Object,
    required: true,
    default: () => ({ avgPower: 0, maxWind: 0, avgTemp: 0 })
  },
  displayedPoints: {
    type: Number,
    default: 0
