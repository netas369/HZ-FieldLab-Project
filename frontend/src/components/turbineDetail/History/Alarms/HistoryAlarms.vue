    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div class="bg-slate-50 dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
        <div class="flex items-center gap-2 mb-1">
          ...
          <div class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Total Alarms</div>
        </div>
      ...
      <div class="bg-red-50 dark:bg-red-900/10 p-4 rounded-xl border border-red-100 dark:border-red-900/30">
        <div class="flex items-center gap-2 mb-1">
          ...
          <div class="text-xs font-semibold text-red-600 dark:text-red-400 uppercase">Critical/Failed</div>
        </div>
        <div class="text-2xl font-bold text-slate-900 dark:text-white">{{ stats.critical }}</div>
      </div>
      ...
      <div class="bg-amber-50 dark:bg-amber-900/10 p-4 rounded-xl border border-amber-100 dark:border-amber-900/30">
        <div class="flex items-center gap-2 mb-1">
          ...
          <div class="text-xs font-semibold text-amber-600 dark:text-amber-400 uppercase">Warnings</div>
        </div>
        <div class="text-2xl font-bold text-slate-900 dark:text-white">{{ stats.warnings }}</div>
      </div>

      <div class="bg-orange-50 dark:bg-orange-900/10 p-4 rounded-xl border border-orange-100 dark:border-orange-900/30">
        <div class="flex items-center gap-2 mb-1">
          ...
          <div class="text-xs font-semibold text-orange-600 dark:text-orange-400 uppercase">Total Downtime</div>
        </div>
        <div class="text-2xl font-bold text-slate-900 dark:text-white">{{ stats.downtime }} hrs</div>
      </div>
    </div>
