  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between text-sm">
      ...
      <span class="text-slate-500 dark:text-slate-400">
        Estimated wait: <span class="font-mono text-indigo-600 dark:text-indigo-400 font-bold">{{ estimatedWait }}s</span>
      </span>
    </div>
    ...
    <div class="relative h-[400px] w-full bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-700 overflow-hidden flex flex-col">
      <!-- Grid Background -->
      <div class="absolute inset-0" style="background-image: linear-gradient(to right, rgba(148, 163, 184, 0.1) 1px, transparent 1px), linear-gradient(to bottom, rgba(148, 163, 184, 0.1) 1px, transparent 1px); background-size: 40px 40px;"></div>
      ...
      <div class="absolute inset-0 flex items-center justify-center">
        <svg class="w-full h-32 text-slate-200 dark:text-slate-700 opacity-50" viewBox="0 0 400 100" preserveAspectRatio="none">
          <path d="M0,50 Q20,60 40,50 T80,50 T120,50 T160,50 T200,50 T240,50 T280,50 T320,50 T360,50 T400,50" fill="none" stroke="currentColor" stroke-width="4" class="animate-[pulse_1.5s_ease-in-out_infinite]"/>
        </svg>
      </div>
