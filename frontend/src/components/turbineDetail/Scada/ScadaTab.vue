          ...
          <div class="flex items-center gap-3">
            <div class="relative w-16 h-16">
              ...
              <svg class="w-16 h-16 transform -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="45" fill="none" stroke="currentColor" stroke-width="2" class="text-slate-300 dark:text-slate-600"/>
        ...
        <div class="flex items-start gap-2">
          ...
          <div class="text-sm">
            ...
            <p class="text-blue-700 dark:text-blue-400 mt-1">
              Nacelle misalignment: {{ formatNumber(Math.abs(scada.nacelle_direction_deg - scada.wind_direction_deg), 1) }}°
            </p>
          </div>
        </div>
      </div>
