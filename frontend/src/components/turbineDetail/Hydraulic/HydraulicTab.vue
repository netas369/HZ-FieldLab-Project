  ...
  <div class="space-y-6">
    ...
    >
      <div class="flex items-center gap-3">
        <div class="flex-shrink-0">
          <svg v-if="isAllNormal" class="w-8 h-8 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
      <div class="p-6">
        <div class="flex items-start justify-between mb-4">
          <div class="flex items-center gap-3">
            <div :class="['p-3 rounded-xl', getStatusBgColor(hydraulic.hydraulic_pressure_status?.color)]">
              <svg class="w-6 h-6" :class="getStatusTextColor(hydraulic.hydraulic_pressure_status?.color)" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
      <div class="p-6">
        <div class="flex items-start justify-between mb-4">
          <div class="flex items-center gap-3">
            <div :class="['p-3 rounded-xl', getStatusBgColor(hydraulic.gearbox_oil_pressure_status?.color)]">
              <svg class="w-6 h-6" :class="getStatusTextColor(hydraulic.gearbox_oil_pressure_status?.color)" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-slate-50 dark:bg-slate-900 rounded-lg p-4">
          <div class="flex items-center justify-between mb-2">
            ...
            <span
                ...
                hydraulic.hydraulic_pressure_status?.color === 'green' ? 'bg-green-500' : 'bg-orange-500'
              ]"
            ></span>
          </div>
        ...
        <div class="bg-slate-50 dark:bg-slate-900 rounded-lg p-4">
          <div class="flex items-center justify-between mb-2">
            ...
            <span
                :class="[
                'w-3 h-3 rounded-full',
                hydraulic.gearbox_oil_pressure_status?.color === 'green' ? 'bg-green-500' : 'bg-orange-500'
              ]"
            ></span>
          </div>
          <p class="text-2xl font-bold text-slate-900 dark:text-white mb-1">
