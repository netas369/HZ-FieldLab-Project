    ...
    <div class="flex flex-col sm:flex-row gap-3">
      ...
      <div class="relative" ref="statusDropdown">
        ...
        >
          ...
          <span>Status</span>
          <span v-if="statusFilters.length > 0" class="px-2 py-0.5 bg-indigo-600 dark:bg-indigo-500 text-white text-xs font-bold rounded-full">
...
const removeStatusFilter = (value) => {
  emit('update:statusFilters', props.statusFilters.filter(f => f !== value))
}
