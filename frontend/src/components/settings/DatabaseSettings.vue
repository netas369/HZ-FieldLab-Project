  ...
  <div class="max-w-3xl">
    ...
    >
      <div class="flex items-start gap-4 mb-6">
        <div
          class="p-3 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/20 rounded-xl border border-red-200 dark:border-red-800"
        >
          <svg
      ...
      <div class="space-y-4">
        <div
          class="p-5 bg-gradient-to-br from-red-50 to-red-100/50 dark:from-red-900/10 dark:to-red-800/5 border border-red-200 dark:border-red-800 rounded-xl"
        >
            ...
            <div>
              ...
              <ul class="text-sm text-slate-600 dark:text-slate-400 space-y-1 ml-4">
                <li class="flex items-center gap-2">
                  <span class="w-1.5 h-1.5 bg-red-500 dark:bg-red-400 rounded-full" />
          ...
          <div
            v-else
            class="mt-4 p-4 bg-white dark:bg-slate-900 rounded-lg border border-red-300 dark:border-red-700"
          >
            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
              Type <span class="font-mono font-bold text-red-600 dark:text-red-400">DELETE</span> to
              confirm:
            </label>
            <input
              v-model="confirmText"
          ...
          <div
            v-if="showSuccess"
            class="mt-4 p-4 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-800/10 border border-emerald-200 dark:border-emerald-800 rounded-lg"
          >
          ...
          <div
            v-if="errorMessage"
            class="mt-4 p-4 bg-gradient-to-br from-red-50 to-red-100/50 dark:from-red-900/30 dark:to-red-800/20 border border-red-300 dark:border-red-700 rounded-lg"
          >
