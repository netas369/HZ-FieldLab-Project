<template>
  <div class="fixed inset-0 z-50 overflow-y-auto" @click.self="$emit('close')">
    <div class="flex min-h-screen items-center justify-center p-4">
      ...
      <div class="relative bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-2xl w-full p-6 border border-slate-200 dark:border-slate-700">
        <!-- Header -->
        ...
        <div class="space-y-4">
          <!-- Normal Range -->
          <div class="p-4 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-800/10 rounded-lg border border-emerald-200 dark:border-emerald-800">
          ...
          <!-- Warning Range -->
          <div class="p-4 bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-amber-900/20 dark:to-amber-800/10 rounded-lg border border-amber-200 dark:border-amber-800">
          ...
          <!-- Critical Range -->
          <div class="p-4 bg-gradient-to-br from-orange-50 to-orange-100/50 dark:from-orange-900/20 dark:to-orange-800/10 rounded-lg border border-orange-200 dark:border-orange-800">
          ...
          <!-- Failed Range -->
          <div class="p-4 bg-gradient-to-br from-red-50 to-red-100/50 dark:from-red-900/20 dark:to-red-800/10 rounded-lg border border-red-200 dark:border-red-800">
          ...
          <div class="flex gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
            <button
                @click="handleSave"
                class="flex-1 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-600 dark:hover:bg-indigo-700 text-white rounded-lg font-medium transition-colors"
            >
              Save Changes
            </button>
            <button
...
const handleSave = () => {
  emit('save', localThreshold.value)
}
</script>